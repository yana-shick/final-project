      ...
      <div className='add-room-menu container'>
        <div className='row justify-content-center g-4'>
          ...
          <div className='col col-7'>
            <select className='form-select' onChange={(e) => { setRoomTypeInp(e.target.value) }}>
          ...
          <div className='col col-7'>
            <input className='form-control' onChange={(e) => { setRoomNameInp(e.target.value) }} maxLength="5" type="text" placeholder='give a name' />
          </div>
          {/* define a color of a room// optional */}
          <div className='col col-7'>
            <select className='form-select' onChange={(e) => { setRoomColorInp(e.target.value) }}>
